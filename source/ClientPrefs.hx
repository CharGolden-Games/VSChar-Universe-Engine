...
class SaveVariables
{
	...
	//public var checkForUpdates:Bool = true; // From Base Psych
	...
	public var showLoadedScripts:Bool = false;

	// VS CHAR SHITTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
	public var vsCharCustomizations:Bool = true;
	public var rotBop:Bool = true;
	public var stickyNotes:Bool = false;
